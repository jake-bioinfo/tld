...
# Temporary options
opt <- list()
opt$in_csv <- "~/pfalci/201908_telomere_lengths/data/202011_ont_processing/200sw_telomere_ranges.perc.sorted.csv"
opt$out_path <- "~/pfalci/201908_telomere_lengths/results/202011_ont"
opt$prefix <- "202011.ont"
opt$threads <- 6
opt$median_values <- "2572,1136"
opt$rename_samples <- "ont_wt,ont_irr"
